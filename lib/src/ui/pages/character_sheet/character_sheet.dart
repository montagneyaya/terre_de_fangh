...
import 'package:terre_de_fangh/src/ui/pages/character_sheet/character_sheet_android.dart';
...
class CharacterSheetPage extends StatelessWidget {
  ...
  Widget _content(BuildContext context) {
    ...
    switch (device.device(context)) {
      ...
      case Devices.androidHandset:
        return const CharacterSheetAndroid();
  ...
  Widget _characterSheetBase(BuildContext context) {
    ...
    switch (device.device(context)) {
      ...
      case Devices.androidHandset:
        return BaseAndroid(
            _content(context), null, false, tabBarAndroid(context, mainTab), homeNavigation(0, context));
      case Devices.iOSHandset:
        // TODO: Handle this case.
        break;
      case Devices.androidTablet:
