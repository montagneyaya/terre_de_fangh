class LangSkills {
  static const String ambidextrous = 'Ambidextrie';
  static const String agoraphobia = 'Agoraphobie';
  static const String callForReinforcements = 'Appel des Renforts';
  static const String savageCall = 'Appel du Sauvage';
  static const String barrelCall = 'Appel du Tonneau';
  static const String bellyCall = 'Appel du Ventre';
  static const String stuffingWeapons = 'Arme de Bourrin';
  static const String scamAndSwindling = 'Arnaque et Carambouille';
  static const String attractsMonster = 'Attire les Monstres';
  static const String inYourFace = 'Bourre-Pif';
  static const String amateurHandyman = 'Bricolo du Dimanche';
  static const String winnerSLuck = 'Chance du Rempailleur';
  static const String groupLeader = 'Chef de Groupe';
  static const String messUp = 'Chercher des Noises';
  static const String ride = 'Chevaucher';
  static const String furl = 'Chouraver';
  static const String understandAnimals = 'Comprendre les Animaux';
  static const String cook = 'Cuistot';
  static const String silentMovement = 'Déplacement Silencieux';
  static const String defuse = 'Désamorcer';
  static const String detect = 'Détecter';
  static const String erudition = 'Erudition';
  static const String climb = 'Escalader';
  static const String blacksmith = 'Forgeron';
  static const String looselyHit = 'Frapper Lâchement';
  static const String poppycock = 'Fariboles';
  static const String diggingThroughTrashCans = 'Fouiller dans les Poubelles';
  static const String survivalInstinct = 'Instinct de Survie';
  static const String treasureInstinct = 'Instinct du Trésor';
  static const String intimidate = 'Intimider';
  static const String jugglingAndDancing = 'Jonglage et Danse';
  static const String monsterLanguages = 'Langue des Monstres';
  static const String mistrust = 'Méfiance';
  static const String beggingAndWhining = 'Mendier et Pleurnicher';
  static const String swim = 'Nager';
  static const String touchingNaivety = 'Naïveté Touchante';
  static const String annoying = 'Pénible';
  static const String track = 'Pister';
  static const String firstAid = 'Premiers Soins';
  static const String skinflint = 'Radin';
  static const String recovery = 'Récupération';
  static const String likeNothing = 'Ressembler à Rien';
  static const String weirdRunes = 'Runes Bizarres';
  static const String feetSmell = 'Sentir des Pieds';
  static const String locksmith = 'Serrurier';
  static const String hollowHead = 'Tête Vide';
  static const String shootProperly = 'Tirer Correctement';
  static const String fallIntoTraps = 'Tomber dans les Pièges';
  static const String painIsForTheWeak = 'Truc de Mauviette';
  static const String superPowerful = 'Super Bourrin';
  static const String attackLeap = "Bond d'Attaque";
  static const String sly = 'Roublard';
  static const String longWeapons = 'Armes Longues';
  static const String fierceBeauty = 'Beauté Féroce';
  static const String ignorant = 'Ignorante';
  static const String survivor = 'Survivante';
  static const String vile = 'Infâme';
  static const String ironGrip = 'Poigne de Fer';
  static const String tormentor = 'Tortionnaire';
  static const String miserable = 'Misérable';
  static const String coward = 'Pleutre';
  static const String surviving = 'Survivaliste';
}

class LangSkillsDescription {
  static const String ambidextrous =
      '''
...
Utilisation : deuxième attaque possible à chaque assaut, avec une épreuve AT-5 / une seule parade.''';
  static const String agoraphobia =
      '''
...
Rattrapage : les équipiers peuvent tenter une épreuve de CHA pour le raisonner.''';
  static const String callForReinforcements =
      '''
...
Utilisation : en cas de fuite d'une scène de combat, le héros ne peut être frappé par les ennemis.''';
  static const String savageCall =
      '''
...
Rattrapage : les équipiers peuvent tenter une épreuve de CHA pour le raisonner.''';
  static const String barrelCall =
      '''
...
Rattrapage : épreuve de CHA (difficile) pour le convaincre ou épreuve de FO (difficile) pour le ceinturer.''';
  static const String stuffingWeapons =
      '''
...
Utilisation : peut s'équiper d'armes à deux mains et les utiliser (une à la fois !).''';
  static const String scamAndSwindling =
      '''
...
Roleplay : pas d'épreuve au dé, mais le joueur doit convaincre le MJ avec un discours abracadabrant !''';
  static const String attractsMonster =
      '''
...
Utilisation : dans le cas d'une rencontre avec des ennemis, le héros est attaqué en premier.''';
  static const String inYourFace =
      '''
...
Utilisation : pas de malus au score AT, dégâts de components 1D6, coups critiques, accès aux coups spéciaux.''';
  static const String amateurHandyman =
      '''
...
Utilisation : fabrication ou réparation possible d'armes rudimentaires, de matériel varié, consolidation : épreuve AD.''';
  static const String winnerSLuck =
  ...
  static const String groupLeader =
      '''
...
Utilisation : bonus +4 sur les épreuves AD de vol à la tire, n'impliquant pas de violence.''';
  static const String understandAnimals =
...
Utilisation : +1PV de récupération sur un repas pour toute l'équipe. Pas d'épreuve.''';
  static const String silentMovement =
      '''
...
Utilisation : bonus +3 sur les épreuves AD pour l'escalade et les numéros de monte-en-l'air.''';
  static const String blacksmith =
      '''
...
Utilisation : aiguiser ou réparer une arme, améliorer une arme avec épreuve AD (voir tableau correspondant).''';
  static const String looselyHit =
      '''
...
Roleplay : le joueur doit également convaincre le MJ avec son discours original !''';
  static const String diggingThroughTrashCans =
      '''
...
Utilisation : en cas de fouille d'un lieu ou d'un cadavre, le héros est le premier à trouver le meilleur butin.''';
  static const String survivalInstinct =
      '''
...
Utilisation : si le héros annonce qu'il suit son instinct de survie, le MJ devra le guider vers la nourriture/boisson proche.''';
  static const String treasureInstinct =
      '''
...
Utilisation : +3 à l'épreuve INT sur une épreuve de fouille ou détection de trésor/cachette.''';
  static const String intimidate =
      '''
...
Utilisation : épreuve de CHA possible pour faire fuir un adversaire moins courageux que le héros.''';
  static const String jugglingAndDancing =
      '''
...
Utilisation : possibilité d'essayer des prestations artistiques sans malus à l'épreuve AD.''';
  static const String monsterLanguages =
      '''
Les monstres disent n'importe quoi, c'est bien connu. Pour le héros qui a fait des études dans ce domaine, pas de problème ! Il comprendra les propos de la plupart des créatures douées de parole : les ogres, les trolls, les gnomes des forêts du nord, les kobolds, etc.
Utilisation : compréhension générale des langues de monstres sans épreuve.''';
  static const String mistrust =
      '''
...
Utilisation : possibilité de tenter une épreuve d'INT pour savoir si un PNJ ment.''';
  static const String beggingAndWhining =
      '''
...
Utilisation : possibilité de nager, +5 à l'épreuve AD sur une épreuve impliquant de la nage.''';
  static const String touchingNaivety =
      '''
...
Utilisation : obligation de faire une pause chaque jour pour continuer à pratiquer la magie / les prodiges. Récupère 4PA.''';
  static const String likeNothing =
      '''
...
Utilisation : les PNJs ne se souviennent pas du héros.''';
  static const String weirdRunes =
      '''
...
Utilisation : épreuve AD possible pour tenter de crocheter une porte, un mécanisme.''';
  static const String hollowHead =
      '''
...
Utilisation : résiste automatiquement à certains types de sortilèges, illusions ou malédictions.''';
  static const String shootProperly =
      '''
...
Utilisation : épreuve AD possible pour utiliser des armes de jet.''';
  static const String fallIntoTraps =
      '''
...
Utilisation : le héros se prend toujours le piège en premier.''';
  static const String painIsForTheWeak =
      '''
...
Utilisation : +1 au score de PR totale, mais ce bonus ne compte pas dans l'encombrement.''';
  ...
  static const String longWeapons =
  ...
  static const String fierceBeauty =
