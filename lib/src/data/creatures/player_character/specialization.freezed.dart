...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Specialization&&(identical(other.name, name) || other.name == name));
}
...
class _Specialization extends Specialization {
  const _Specialization({this.name = 'none'}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Specialization&&(identical(other.name, name) || other.name == name));
}
